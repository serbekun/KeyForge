...
pub fn interpret_arguments_from_command_line(args: &[String], repeat_mod: bool) -> Result<(), String> {
    if args.is_empty() {
        return Ok(());
    }
    ...
    match args[0].as_str() {
        ...
        "repeat" => {
            ...
            for i in 0..repeat_count {
                if let Err(e) = interpret_arguments_from_command_line(&args_for_repeat, true) {
            ...
            Ok(_) => {
                ...
                match input.to_lowercase().as_str() {
                    ...
                    _ => {
                        ...
                        match interpret_arguments_from_command_line(&args, false) {
                            Ok(()) => {}
